  ...
  return (
    <div className="mobile-view-container w-full min-h-dvh bg-black">
                  ...
                  <div key={tabIndex} className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {tabGroup.sections.map((section, sectionIndex) => (
                        ...
                        >
                          <span className="text-base text-white font-medium">{section.title}</span>
                        </button>
                      ))}
                    </div>
                  </div>
          ...
          <>
            ...
            <div className="relative z-10">
              ...
              <div className="bg-black/50 backdrop-blur-md border-t border-b border-gray-800 p-6 py-8">
                ...
                <div className="space-y-8">
                  <div className="flex justify-center mb-8">
                    <Image src="/images/logo_blackback.png" alt="Omnius" width={280} height={84} />
                  </div>
              ...
              <div className="bg-black/50 backdrop-blur-md border-t border-b border-gray-800 p-6 py-8">
                ...
                <div className="space-y-8">
                  <div className="text-sm uppercase tracking-widest text-blue-400">Mission</div>
              ...
              <div className="bg-black/50 backdrop-blur-md border-t border-b border-gray-800 p-6 py-8">
                ...
                <div className="space-y-8">
                  <div className="text-sm uppercase tracking-widest text-purple-400">Value</div>
                  <h3 className="text-2xl font-black text-white leading-tight">
                    革新し、創造し、先導する
                  </h3>
                  <p className="text-sm text-gray-300 leading-relaxed mb-4">
        ...
        {viewState.type === 'tab' && (
          ...
          <div className="relative z-10">
            ...
            {tabGroups[viewState.tabIndex].sections.map((section, sectionIndex) => {
              // 最後のセクションの余白を統一
              const isLastSection =
                sectionIndex === tabGroups[viewState.tabIndex].sections.length - 1;
                        ...
                        if (targetSectionIndex !== -1) {
                          setTimeout(() => {
                            const element = document.getElementById(
                              `section-${viewState.tabIndex}-${targetSectionIndex}`
                            );
                            if (element) {
      ...
      <style jsx global>{`
        ...
        .mobile-view-container
          .mobile-section-content
          div[class*='grid'][class*='grid-cols-2'][class*='grid-rows']:not(.who-we-want-grid):not(
            .work-environment-grid
          ) {
        ...
        .mobile-view-container
          .mobile-section-content
          div[class*='grid'][class*='grid-cols-2'][class*='grid-rows']
          > div.leadership-card {
